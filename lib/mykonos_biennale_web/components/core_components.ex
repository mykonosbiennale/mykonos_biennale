defmodule MykonosBiennaleWeb.CoreComponents do
  ...
  @doc """
  Renders the admin navigation bar shared across all admin screens.

  ## Examples

      <.admin_nav current_page="biennales" />
  """
  attr :current_page, :string, default: nil

  def admin_nav(assigns) do
    ~H"""
    <div class="bg-gray-900/50 border-b border-purple-500/20">
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-8">
            ...
            <nav class="flex space-x-4">
              ...
              <.link
                navigate="/admin/biennales"
                class={
                  if @current_page == "biennales",
                    do: "text-white font-semibold",
                    else: "text-gray-400 hover:text-white transition-colors"
                }
              >
