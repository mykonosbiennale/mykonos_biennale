defmodule MykonosBiennaleWeb.SitePageHTML do
  use MykonosBiennaleWeb, :html

  embed_templates "site_page_html/*"
  ...
  defp render_to_iodata(%Phoenix.LiveView.Rendered{static: static, dynamic: nil}) do
    static
  end
